...
def evaluate(weight_file_path, data_dir, output_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  model = face_detect_model.Model(weight_file_path)
...
def main():
  ...
  argparse.add_argument('--weight_file_path', type=str, help='Pretrained weight file.', default="./pkl_file/hr_res101.pkl")
  argparse.add_argument('--data_dir', type=str, help='Image data directory.', default="./images")
  argparse.add_argument('--output_dir', type=str, help='Output directory for images with faces detected.', default="./output_images")
  ...
  #print('ARGUMENTS ---- ', args.weight_file_path)	
  # check arguments
